...
def main():
    detector = Detector(training_features='features/'
                                'training_set_features_for_binary_detector2.txt',
                        training_gt='features/training_set_GT_for_binary_detector2.txt')
    detector.deserialize_model_parameters(
        'training_parameters/binary_detector_training_params2.ds')

    classifier = Detector(training_features='features/'
                                          'training_set_features.txt',
                        training_gt='features/training_set_GT.txt')
    classifier.deserialize_model_parameters(
