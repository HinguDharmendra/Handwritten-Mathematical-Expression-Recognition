...
def main():
    detector = Detector('features/parser_bonus_features.txt',
                        'features/parser_bonus_GT.txt')

    # when training
    detector.random_forest_train()
    detector.serialize_model_parameters(
        'training_parameters/parser_bonus.ds')

    # when testing
    # detector.deserialize_model_parameters(
    #     'training_parameters/parser_training_params_los.ds')
    # detector.random_forest_test()
