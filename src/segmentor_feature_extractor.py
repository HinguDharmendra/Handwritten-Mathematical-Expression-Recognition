...
def main():
    # training files
    with open('training_files.txt', 'r') as file_pointer:
    ...
    with open('features/training_set_features_for_binary_detector.txt',
              'w') as \
            file_pointer:
        file_pointer.write(json.dumps(features_set))

    with open('features/training_set_GT_for_binary_detector.txt', 'w') as \
            file_pointer:
